...
const SkeletonRenderer = (function () {
  ...
  */
  function drawUser(
    ...
    ctx.save();
    const opacity = key => displayVisibility ? (displayVisibility[key] ?? 0) : 1;
    ...
    */
    SEGMENTS.forEach(
      ([a, b, part]) => {
        ...
        ctx.globalAlpha = Math.min(opacity(a), opacity(b));
