/* =====================================================================
   SQUAT DETECTOR — v0.3 (movement starts counting)
   ---------------------------------------------------------------------
...
const SquatDetector = (function () {
  ...
  // Keep completed reps while cancelling only an uncertain in-progress
  // movement after tracking has been lost for a while.
